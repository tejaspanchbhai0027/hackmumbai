            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <Card className="text-center">
                        ...
                        <div className="text-3xl font-bold text-primary-400">{predictions.length}</div>
                ...
                {predictions.length === 0 ? (
                    <Card className="text-center py-12">
                        ...
                        <p className="text-gray-400 mb-6">Start by making your first prediction!</p>
                        <Link to="/predict">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                                            <div className="text-gray-400">
                                                📚 Study: <span className="text-white">{pred.student_data.hours_studied}h</span>
                                            </div>
                                            <div className="text-gray-400">
                                                😴 Sleep: <span className="text-white">{pred.student_data.sleep_hours}h</span>
                                            </div>
                                            <div className="text-gray-400">
                                                ✅ Attendance: <span className="text-white">{pred.student_data.attendance_percent}%</span>
                                            </div>
                                            <div className="text-gray-400">
                                                📊 Previous: <span className="text-white">{pred.student_data.previous_scores}</span>
                                            </div>
                                        </div>
                                    </div>
