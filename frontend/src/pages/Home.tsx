            ...
            <section className="flex-1 flex items-center justify-center px-4 py-20">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-2xl md:text-3xl text-gray-300 mb-4 animate-slide-up">
                        Real-time Student Exam Success Prediction
                    </p>
                    <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="card text-center animate-scale-in" style={{ animationDelay: '0.1s' }}>
                            ...
                            <h3 className="text-xl font-semibold mb-3 text-primary-300">Accurate Predictions</h3>
                        ...
                        <div className="card text-center animate-scale-in" style={{ animationDelay: '0.2s' }}>
                            <div className="text-5xl mb-4">⚡</div>
                            <h3 className="text-xl font-semibold mb-3 text-primary-300">Real-time Results</h3>
                            <p className="text-gray-400">
                        ...
                        <div className="card text-center animate-scale-in" style={{ animationDelay: '0.3s' }}>
                            <div className="text-5xl mb-4">💡</div>
                            <h3 className="text-xl font-semibold mb-3 text-primary-300">Actionable Insights</h3>
                            <p className="text-gray-400">
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-400">Input your study habits and academic history</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-400">Our algorithm analyzes your profile</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-400">Receive your exam score prediction</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-400">Follow personalized recommendations</p>
                        </div>
                    </div>
                </div>
            </section>
